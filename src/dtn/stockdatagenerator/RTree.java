  ...
  public String saveInFile(String filename){
	  ...
	  File file = new File(filename);
		...
		try {
			...
			oos.writeInt(maxEntries);
			oos.writeInt(minEntries);
			oos.writeInt(numDims);
			//pointDims ?
			oos.writeObject(seedPicker);
  ...
  public String loadFromFile(String filename){
	  String status = "";
		...
		try {
			...
			maxEntries = ois.readInt();
			minEntries = ois.readInt();
			numDims = ois.readInt();
			seedPicker = (SeedPicker) ois.readObject();
			root = (Node) ois.readObject();
			size = ois.readInt();
			ois.close();
			
			return "Load file sucessful";
